...
const BookingsSpotId = ({ rating, price, id }) => {
    ...
    }, [dispatch, checkIn, checkOut, showCalendar, calClick])
    ...
    console.log(calClick, 'cal click')
...
console.log('November 01, 2022' === 'November 1, 2022')
